...
def get_test_scenarios() -> list:
    ...
    scenarios = [
        ...
        ("Dist-ZonaNorte1", "Dist-ZonaSul2", 
         "Comunicação entre distribution routers de regiões diferentes"),
        
        ("Access-Bairro1", "Dist-ZonaNorte1", 
         "Subida hierárquica: Access → Distribution"),
        
        ("Core-Norte", "Access-Bairro3", 
         "Descida hierárquica: Core → Access (passando por regiões)"),
    ]
